  ...
  await prisma.article.createMany({
    data: [
      ...
      },
      {
        ...
        content:
          'Tech Quest でのプログラミング学習2日目！\n\n今日から本格的にプログラミングの学習が始まった。\nまずはWebアプリの基本処理となる CRUD というのを学ぶらしい。\nCRUD というのは「Create(作成)」「Read(読み取り)」「Update(更新)」「Delete(削除)」の略で、普段使っているWebアプリも基本的にはこれらの処理をDB(データベース)に対して行うことで表示してるらしい！\nうーん...難しそうww\n\nでも確かに普段使ってる X も「ツイート(Create)」「タイムライン(Read)」「ツイートの削除(Delete)」だし、プロフィールとかであれば「変更(Update)」できるなって考えたら「もしかして自分でも作れる」って思えてきた！\n\nうおおおおお！頑張るぞ〜〜〜！！！！',
        category: 'プログラミング',
        status: '公開',
